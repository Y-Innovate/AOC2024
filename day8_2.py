...
for idxToCheck in range(0, len(allToCheck)):
    ...
    for idx1 in range(0, len(found) - 1):
        for idx2 in range(idx1 + 1, len(found)):
            if matrix2[found[idx1][1]][found[idx1][0]] != '#':
                uniqueAntinodes += 1
                matrix2[found[idx1][1]][found[idx1][0]] = '#'

            if matrix2[found[idx2][1]][found[idx2][0]] != '#':
                uniqueAntinodes += 1
                matrix2[found[idx2][1]][found[idx2][0]] = '#'
            ...
            while antinode1[0] >= 0 and antinode1[0] < sizX and \
            ...
            while antinode2[0] >= 0 and antinode2[0] < sizX and \
